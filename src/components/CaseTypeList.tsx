    ...
    <>
      ...
      {caseTypes.length === 0 ? (
        <div className="p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg">No case types found</p>
          <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">Create your first case type to get started</p>
        </div>
      ) : (
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
              {caseTypes.map((caseType, index) => (
                <tr key={caseType.id || index} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
